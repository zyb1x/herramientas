            ...
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex justify-start items-center">
                    ...
                    @if (!$isLoginPage && session('api_token'))
                        ...
                        @if (in_array(session('usuario')['rol'], ['Administrador', 'Almacenista']))
                            <ul>
                                <li class="relative">
                                    <button id="dropdownDevolverButton" data-dropdown-toggle="dropdownDevolver"
                                        data-dropdown-placement="bottom"
                        ...
                        @endif
                        @if (in_array(session('usuario')['rol'], ['Administrador', 'Supervisor']))
                            <ul>
                                <li class="relative">
                                    <button id="dropdownEnsambleButton" data-dropdown-toggle="dropdownEnsamble"
                                        data-dropdown-placement="bottom"
                                        class="flex items-center justify-between w-full py-2 px-3 rounded font-medium text-white md:w-auto
                            hover:bg-orange-500 md:hover:bg-transparent md:border-0 md:hover:text-orange-500 md:p-0 duration-200 ml-3">
                                        Ensambles
                                        <svg class="w-4 h-4 ms-1.5" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="none" viewBox="0 0 24 24">
                ...
                @if (!$isLoginPage && session('api_token'))
                    <div class="flex items-center gap-2 lg:order-2">
                        ...
                        @if (in_array(session('usuario')['rol'], ['Administrador', 'Almacenista']))
                            ...
                            <ul>
                                <li class="relative">
                                    <button id="dropdownHerramientasButton"
                                        data-dropdown-toggle="dropdownHerramientas" data-dropdown-placement="bottom"
                                        class="flex items-center justify-between w-full py-2 px-3 rounded font-medium text-white md:w-auto
                            hover:bg-orange-500 md:hover:bg-transparent md:border-0 md:hover:text-orange-500 md:p-0 duration-200">
                                        Herramientas
                                        <svg class="w-4 h-4 ms-1.5" aria-hidden="true"
                        ...
                        @if (session('usuario'))
                            ...
                            <div id="user-dropdown"
                                ...
                                <div class="px-4 py-3 text-sm">
                                    ...
                                    <span
                                        class="inline-block mt-2 px-2 py-1 text-xs font-medium rounded-full bg-blue-100">
                                        {{ session('usuario')['rol'] }}
                                    </span>
